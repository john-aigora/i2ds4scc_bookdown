...
```
<!-- When I run this code, I get an error for the last command. I guess you mean "high_prot_data" instead of "data" --> 
...
<!-- Did you mean 1 value after the decimal? --> 
```{r}
...
```
 <!-- I got this message when I ran this last code saying: Error in saveWorbook(wb, file = "temp/excel export.xlsx") : 
