...
Markdown is an ecosystem specific to text document, in which authors *program* their documents by controlling various features including:
...
If you intend to build your report in pdf, you also need to install a LaTeX library. For its simplicity, recommend you installing the TinyTeX library using `install.packages("tinytex")`.
...
To illustrate the use of `{rmarkdown}`, let's consider this simple document (REF):
