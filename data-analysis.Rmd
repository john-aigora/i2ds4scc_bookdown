...
As can be seen, the pattern of liking scores across samples is indeed very stable across the evaluation, the evaluation at the end being slightly more extreme: Samples that were liked (e.g. P10) are even more liked at the end, whereas samples that were disliked (e.g. P4, P8) are even more disliked.
