...
Although the correlation provides a first good idea of which attributes are somewhat linked to liking, it has two major drawbacks: 1. it only measures linear relationships, and 2. it does not allow for inference. 
To overcome this, we use linear and quadratic regression.
