...
\caption{Product set for the biscuit study}(\#tab:biscuit-set)\\
...
\docline{2pt}{000000}{1-4}\endhead
...
\caption{General design for the consumer test of the biscuit study. Participants were served with a different set of biscuits every session.}(\#fig:test-design)
\end{figure}
