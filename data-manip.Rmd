...
<!-- Vanessa: Maybe we can import and define sensory data in here and only mention chapter 8 for further details on data import? This will avoid the user to have to stop and go check in another chapter how sensory was imported/defined / Also for sensory we import the data in thsi chapter.-->
...
<!-- vanessa: maybe it should install the `reshape2` library before the code --> 
...
<!-- Vanessa: Make the first and last ( ) can be removed and consumption called after the function, as in the next code --> 
