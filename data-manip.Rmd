...
For this chapter, most functions used are from the `{tidyverse}`:
...
>Throughout this chapter, many transformations made are not being saved. If you want to apply these changes to your data set, please visit \@ref(print-save).
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, fig.cap="Example of a table for an Analysis of Variance"}
tibble(Consumer = c("C1","C1","...","C1","C2","...","c","...","C"),
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, fig.cap="Example of a table for Internal Preference Mapping or Clustering"}
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, fig.cap="Example of Mean Table"}
tibble(Product = c("P1","P2","...","p","...","P"),
...
#### Illustrations of Data Manipulation {#means}
...
> As you can see, R provides the following message: *`summarise()` has grouped output by 'Product'. You can override using the `.groups` argument.* This message is just informative, and can be hidden by adding the following code at the start of your script:
