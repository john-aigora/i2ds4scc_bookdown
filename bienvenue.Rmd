...
#### Specific features of data handled in sensory and consumer science {-}

<!-- As a direct consequence of the need to understand consumers and their preferences, sensory and consumer scientists deal with multiple data, of various types, that may all relate to each other, so that they may be arranged in a L-shaped data sets  -->

<!-- Relatively small data sets -->

<!-- Quantitative, qualitative, or both -->

<!-- Unique methods: for measurement (temporal methods, holistic/distances, JARs, CATA), and for data analysis (penalty analysis, prefmap, hmfa, LVclus, Distatis...) -->
