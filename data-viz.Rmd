...
```{r, message=FALSE, warning=FALSE, echo = TRUE, eval = TRUE, tab.cap="Appearance Attributes Mean (Basic Flextable)"}
library(flextable)  
...
```{r, message=FALSE, warning=FALSE,  tab.cap="Appearance Attributes Mean (Basic Flextable 2)"}
...
```{r, message=FALSE, warning=FALSE, tab.cap="Appearance Attributes Mean (Improved Flextable)"}
...
```{r, message=FALSE, warning=FALSE, tab.cap="Consumption time and number of biscuits eaten"}
...
<!-- Table cap doesn't appear --> 
```{r, message=FALSE, warning=FALSE, tab.cap="Number of biscuits eaten"}
