...
107 women of normal weight (Body Mass Index (BMI): 18-26) participated to the test. All were regular consumers of breakfast biscuits. The *biscuits_traits.xlsx* file gives some socio-demographic information (e.g. marital status,  household, income, occupation) of these consumers.
