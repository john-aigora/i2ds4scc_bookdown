...
This files also gives participants' answers to a self-assessment questionnaire (Q12-62) that evaluates eating behavioral traits, in particular the tendency to control food intake cognitively. Resulting scores are loaded into three factors: cognitive restraint, disinhibition, and susceptibility to hunger. This questionnaire is thus known as the Three-Factor Eating Questionnaire (TFEQ) [@stunkard1985]. Calculation of these factors is detailed in chapter [\@ref(data-analysis)].
...
1. with a horizontally oriented unstructured linear scale (VAS) anchored with *‘I don’t like this biscuit at all’* (left end) and *‘I like this biscuit a lot’* (right end) at two different times: after the first bite and at the end of their consumption.
