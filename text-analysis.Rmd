...
This procedure already provides some interesting information as we can readily count word usage, for instance how often the word *apple* is used to describe each samples. However, a deeper look at the data shows some inconsistencies since some words starts with a space, or have capital letters (remember that R is case-sensitive!).
