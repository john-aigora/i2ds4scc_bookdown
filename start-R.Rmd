...
GitHub is a cloud-based service that supports Git usage. It allows online backups of your code and which facilitates collaboration between team members. While Git creates local repositories on your computer, GitHub allows users to create remote repositories, stored online, for their code.

To set up GitHub, follow the steps bellow:

1) Register for a GitHub Account
To get started you can sign up for a free GitHub account: https://github.com/.
...
Once you log into your account, create a new repository by clicking the green button 'New'. You have to then name your repository and make some selections. We recommend you selecting the option 'Private' and clicking on the option "Initialize this repository with a README". Last step is to click on 'Create Repository'.
...
Once you are done with your coding or have finished updating a series of scripts, you can simply push, or send them to GitHub, so others can see your changes. You have to first commit and them push it to GitHub. To do so, you can click the 'Git' icon on the top menu and select the option 'Commit'. You can select what you want to commit and describe the changes you did. After comitting your code/files, you have to push it by clicking the option 'Push'.

6) Pull Changes
In case you are working with other colleagues, a good practice is to always pull (which means download) the code before you get started and before pushing any changes. The option pull you simple update the repository based on changes others may have done. To do so, you can click the 'Git' icon on the top menu and select the option 'Pull'.
