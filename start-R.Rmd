...
Writing the code to get used to it.

Showing vs. Saving changes (example of renaming variables) --> use of parenthesis to save and show?
Overwriting results vs. Saving results in a new variable
Long pipes: *debugging* by running some small portion of codes
