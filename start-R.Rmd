...
Like any language, R is best learned first through example then through study. Lets start with a simple example where we  analyze a series of Tetrad tests to illustrate the basic principles. 
