...
As we have seen, to create a new project,  select 'File' --> 'New Project...' from the top bar menu or by clicking on the ‘Project’ button in the top right of RStudio and selecting ‘New Project…’. You will select 'Version Control' --> 'Git'. Paste the repository URL link, select where you want to save this project locally, and click "Open in new session". Finally, click 'Create Project'.
