...
```{r, eval=TRUE, echo=FALSE, message=FALSE, out.width='90%', fig.cap='Example of a table for an Analysis of Variance.'}
tibble(
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, out.width='90%', fig.cap='Example of a table for Internal Preference Mapping or Clustering'}
tibble(
  Product = c("P1", "P2", "...", "p", "...", "P"),
  C1 = c(6, 8, "...", 3, "...", 5),
  C2 = c(8, 4, "...", 7, "...", 6),
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, out.width='90%', fig.cap='Example of Mean Table'}
