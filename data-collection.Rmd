...
However, this type of approach also comes with drawbacks as it may imply order effects and carry-over effects. It may even induce response biases. Fortunately, most of these effects can be controlled with a proper design of experiment.
<!-- See if pure monadic designs should be briefly mentionned here -->
