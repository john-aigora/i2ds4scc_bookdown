...
```{r eval=TRUE, echo=FALSE, message=FALSE, label="biscuit-mixt", tab.cap="Average liking scores obtained for the biscuits from the mixture design"}
library(mixexp)
library(AlgDesign)
library(tidyverse)
