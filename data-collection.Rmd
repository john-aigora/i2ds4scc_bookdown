...
One may also be tempted to use incomplete balanced block designs for hedonic tests too. However, proceeding this way incurs high risks to induce biases. Indeed, each participant to the consumer tests will only see part of the product set which would be likely to affect their frame of reference if the subset of product they evaluate only cover a limited area of the sensory space.
