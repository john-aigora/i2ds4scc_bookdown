...
* **Quantification**  
Finally, experimenters must anticipate what type of information they are looking for / and thus what type of analysis they will (be able) to conduct. The means of quantification (counts, sorting, ranking, scaling, mapping, etc.) should have been set long before execution when the study is designed. When time comes to run the tests, the experimenter will have to rely on a proper and reliable way to collect data. Commercial sensory softwares allow to collect any type of data... However, in some cases, the experimenter may choose to ask panelists to use paper and pencil, or just to give a verbal answer, or to arrange the samples physically on a table. Care must then be taken to ensure, proper coding/entering data into a spreadsheet, etc, before moving to next steps and importing data to R (see next section).
