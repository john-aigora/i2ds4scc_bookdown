...
<!-- Vanessa: Maybe table and text can be rearranged so the table 8.1 shows up after a quick explanation on this table is about. In the way it is here the table shows beforeit is called in the text.  --> 
