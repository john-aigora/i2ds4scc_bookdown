...
Let's start with the simple example where the tables match in terms of variables, and should be combined vertically. This example can be applied to the example presented in \ref{import-mult-sheet}

\texttt{full\_join()} and derivatives
\texttt{bind\_rows()} and \texttt{bind\_cols()}
