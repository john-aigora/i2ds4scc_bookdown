...
\hypertarget{part-setting-the-table}{%
\part*{Setting the Table}\label{part-setting-the-table}}
\addcontentsline{toc}{part}{Setting the Table}
...
\hypertarget{tidying-data---pre-requisite}{%
\subsection{Tidying Data - Pre-Requisite}\label{tidying-data---pre-requisite}}

\hypertarget{transformation-without-altering-the-data}{%
\subsubsection{Transformation without Altering the Data}\label{transformation-without-altering-the-data}}
...
\subsubsection{Transformation that Alters the Data}\label{transformation-that-alters-the-data}}
...
\subsubsection{Handling Lists of Tables}\label{handling-lists-of-tables}}
...
\hypertarget{part-delighting-your-guests}{%
\part*{Delighting Your Guests}\label{part-delighting-your-guests}}
\addcontentsline{toc}{part}{Delighting Your Guests}
...
\hypertarget{part-cooking-with-gas}{%
\part*{Cooking with Gas}\label{part-cooking-with-gas}}
\addcontentsline{toc}{part}{Cooking with Gas}
...
\chapter{Future Delights}\label{next-steps}}
...
\hypertarget{start-R}{%
\chapter{Getting Started in R}\label{start-R}}
...
\subsection{Principles}\label{principles-2}}
...
\chapter{Recommended Resources}\label{resources}}
