...
\CommentTok{\# invisible(capture.output(res \textless{}{-} MixModel(Bmixt, "Liking",}
\CommentTok{\#                                          mixcomps = c("Butter", "Sugar", "Flour"), model = 4)) )}
\CommentTok{\# \# plot the model as ternary contour plot}
\CommentTok{\# ModelPlot(model = res,}
\CommentTok{\#           dimensions = list(x1="Butter", x2="Sugar", x3="Flour"),}
\CommentTok{\#           lims = c(0.15, 0.30, 0.25, 0.40, 0.30, 0.50), constraints = TRUE,}
\CommentTok{\#           contour = TRUE, cuts = 12, fill = TRUE, pseudo = TRUE,}
\CommentTok{\#           axislabs = c("Butter", "Sugar", "Flour"))}
\end{Highlighting}
\end{Shaded}
...
Other informative solutions consists in printing a summary of the data through the \texttt{summary()} function, or looking at its type and first values using \texttt{str()}. However, due to its richness of the outputs, the \texttt{skim()} function from the \texttt{\{skimr\}} package is preferred.
...
\NormalTok{pca\_ws\_plot}
\CommentTok{\# ggsave("output/pca\_without\_scaling.jpg", pca\_ws\_plot)}

\CommentTok{\# scaling data + PCA {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}

\NormalTok{pca\_results }\OtherTok{\textless{}{-}}\NormalTok{ wine\_dataset }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{prcomp}\NormalTok{(}\AttributeTok{scale. =} \ConstantTok{TRUE}\NormalTok{)}

\FunctionTok{summary}\NormalTok{(pca\_results)}
\FunctionTok{plot}\NormalTok{(pca\_results)}

\NormalTok{pca\_plot }\OtherTok{\textless{}{-}} \FunctionTok{autoplot}\NormalTok{(pca\_results, }\AttributeTok{data =}\NormalTok{ wine\_dataset,,}
               \AttributeTok{loadings =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{loadings.colour =} \StringTok{\textquotesingle{}red\textquotesingle{}}\NormalTok{,}
               \AttributeTok{loadings.label =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{loadings.label.size =} \DecValTok{3}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{()}

\NormalTok{pca\_plot}
\CommentTok{\# ggsave("output/pca.jpg", pca\_plot)}

\NormalTok{reduced\_dataset }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(pca\_results}\SpecialCharTok{$}\NormalTok{x[, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{]) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{tibble}\NormalTok{()}
\CommentTok{\# we can see that clustering should be easy}

\CommentTok{\# Clustering  {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}

\CommentTok{\# Finding number of clusters {-} Elbow method}
\NormalTok{wcss }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{()}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{) \{}
  
\NormalTok{  wcss }\OtherTok{\textless{}{-}}\NormalTok{ wcss }\SpecialCharTok{\%\textgreater{}\%} 
    \FunctionTok{bind\_rows}\NormalTok{(}\FunctionTok{tibble}\NormalTok{(}\AttributeTok{n\_clusters =}\NormalTok{ i,}
                     \AttributeTok{wcss =} \FunctionTok{kmeans}\NormalTok{(reduced\_dataset, i)}\SpecialCharTok{$}\NormalTok{tot.withinss))}
  
\NormalTok{\}}

\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{wcss, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{n\_clusters, }\AttributeTok{y=}\NormalTok{wcss, }\AttributeTok{group=}\DecValTok{1}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{size =} \FloatTok{1.5}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape=}\DecValTok{21}\NormalTok{, }\AttributeTok{fill=}\StringTok{"blue"}\NormalTok{, }\AttributeTok{color=}\StringTok{"darkred"}\NormalTok{, }\AttributeTok{size=}\DecValTok{5}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Number of clusters"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Total within{-}cluster sum of squares"}\NormalTok{)}

\CommentTok{\# ggsave("output/n\_clusters\_decision\_Elbow.jpg")}

\CommentTok{\# Finding number of clusters {-} silhouette method}
\FunctionTok{fviz\_nbclust}\NormalTok{(reduced\_dataset, kmeans, }\AttributeTok{method =} \StringTok{"silhouette"}\NormalTok{)}
\CommentTok{\# ggsave("output/n\_clusters\_decision\_silhouette.jpg")}

\CommentTok{\# 3 clusters seems to be good fit}
...
\CommentTok{\# ggsave("output/clustered\_data.jpg")}

\CommentTok{\# Classification {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}

\CommentTok{\# Dataset preparation}
\NormalTok{wine\_classification\_dataset }\OtherTok{\textless{}{-}}\NormalTok{ reduced\_dataset }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{bind\_cols}\NormalTok{(}\FunctionTok{tibble}\NormalTok{(}\AttributeTok{Wine\_type =}\NormalTok{ km\_dw}\SpecialCharTok{$}\NormalTok{cluster)) }\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# Our classification label is the clustering output}
