...
Markdown is an ecosystem specific to text document, in which authors \emph{program} their documents by controlling various features including:
...
Limiting the creation of Markdown document through this list of elements is more an advantage than a drawback as it suffice to create technical and non-technical document while still keeping it a certain simplicity.
...
If you intend to build your report in pdf, you also need to install a LaTeX library. For its simplicity, recommend you installing the TinyTeX library using \texttt{install.packages("tinytex")}.
...
To illustrate the use of \texttt{\{rmarkdown\}}, let's consider this simple document (REF):
...
-\textgreater{} Keep track of what has been done (reproducible research): Explain choices for analysis, table presentation, charts
-\textgreater{} Sharing code/analysis
...
\tightlist
\item
  Connects our analysis tool to our preferred reporting tool;
\item
  Liberate resources for scientists to focus on the interpretation and communication of results\ldots{}
\item
  \ldots while simultaneously reducing errors and increasing the consistency of their analyses.
\end{enumerate}
