...
\CommentTok{\# mdes2 \textless{}{-} Xvert(nfac=3, uc=c(.30, .40, .50), lc=c(.15, .25, .30), ndm = 2, plot = FALSE) \%\textgreater{}\% }
\CommentTok{\#       mutate(across(where(is.numeric), round, digits = 3))}
\CommentTok{\# }
\CommentTok{\# MixtBisc \textless{}{-} optFederov(\textasciitilde{} {-}1 +x1 +x2+ x2 +x1:x2 +x1:x3 +x2:x3 +x1:x2:x3, mdes2, nTrials=9)}
\CommentTok{\# DesignPoints(MixtBisc$design, axislabs = c("Butter","Sugar","Flour"), pseudo = TRUE)}
\end{Highlighting}
\end{Shaded}
