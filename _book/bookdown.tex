...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Flextable\ -\ lines\ adjustment\ function}}}}\label{tab:unnamed-chunk-106}\\
...
\caption{\label{fig:unnamed-chunk-137}Scatter plot with emphasis on the display through \texttt{theme()}, \texttt{scale\_continuous()}, \texttt{coord\_fixed()}, \texttt{ggtitle()} and \texttt{guides()}}
\end{figure}
