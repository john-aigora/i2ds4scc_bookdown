...
Dr.~Julien Delarue is Associate Professor at the University of California Davis. He received his Ph.D.~in Food Science at AgroParisTech, and his research focuses on methods to measure sensory perception and preferences and on their effective use in food design. He explores the role of context in hedonic measures using immersive environments and digital technologies. He also works to develop and validate rapid and flexible descriptive analysis methods with application to new product development and consumer research. Formerly a Professor at AgroParisTech, France in the food science and technology joint research unit with INRAE and Université Paris-Saclay, he has served as the Chair of the French Society for Sensory Analysis (SFAS) and of the European Sensory Science Society (E3S).
...
## i When switching from `summarise()` to `reframe()`, remember that `reframe()` always returns an
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Example\ of\ a\ table\ for\ an\ Analysis\ of\ Variance.}}}}\label{tab:longthin}\\

\ascline{2pt}{666666}{1-3}

\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Consumer}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Liking}}}} \\

\ascline{2pt}{666666}{1-3}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{6}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P2}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{8}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{...}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{...}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{...}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{5}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C2}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{8}}}} \\
...
\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{c}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{p}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{L(c,p)}}}} \\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Example\ of\ a\ table\ for\ Internal\ Preference\ Mapping\ or\ Clustering}}}}\label{tab:unnamed-chunk-36}\\

\ascline{2pt}{666666}{1-7}

\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C2}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{\ ...}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{c}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{...\ }}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C}}}} \\

\ascline{2pt}{666666}{1-7}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{6}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{8}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P2}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{8}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{4}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{...}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{...}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{...}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{p}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{3}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{7}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{L(p,c)}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{L(p,C)}}}} \\
...
\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{5}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{6}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{L(P,c)}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.41in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{.}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{L(P,C)}}}} \\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Example\ of\ Mean\ Table}}}}\label{tab:unnamed-chunk-37}\\

\ascline{2pt}{666666}{1-2}

\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Liking}}}} \\

\ascline{2pt}{666666}{1-2}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{6.4}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P2}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{8.2}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{...}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{...}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{p}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{7.1}}}} \\
...
\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{6.1}}}} \\
...
## i In argument: `across(where(is.numeric), round, digits = 0)`.
## Caused by warning:
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Fictive\ example\ shaped\ in\ a\ long\ thin\ format.}}}}\label{tab:unnamed-chunk-72}\\

\ascline{2pt}{666666}{1-3}

\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Consumer}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Liking}}}} \\

\ascline{2pt}{666666}{1-3}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P1}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{8}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C1}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P2}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{5}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C2}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P1}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{9}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C2}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P2}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{6}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C3}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P1}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{7}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.8in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C3}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P2}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{4}}}} \\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Fictive\ example\ restructured\ in\ a\ short\ wide\ format.}}}}\label{tab:unnamed-chunk-73}\\

\ascline{2pt}{666666}{1-4}

\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C1}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C2}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C3}}}} \\

\ascline{2pt}{666666}{1-4}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P1}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{8}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{9}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{7}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P2}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{5}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{6}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.42in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{4}}}} \\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Tables\ used\ to\ illustrate\ the\ different\ mergeing\ options.}}}}\label{tab:unnamed-chunk-89}\\

\ascline{2pt}{666666}{1-2}

\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Var1}}}} \\

\ascline{2pt}{666666}{1-2}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{A}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{1}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{B}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{2}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{3}}}} \\
...
\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Var2}}}} \\
...
\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{D}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{4}}}} \\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Illustration\ of\ the\ 'full\_join()'\ option.}}}}\label{tab:unnamed-chunk-90}\\

\ascline{2pt}{666666}{1-3}

\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Var1}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Var2}}}} \\

\ascline{2pt}{666666}{1-3}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{A}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{1}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{1}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{B}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{2}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{2}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{3}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{D}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.52in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{4}}}} \\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Illustration\ of\ the\ 'inner\_join()'\ option.}}}}\label{tab:unnamed-chunk-91}\\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Illustration\ of\ the\ 'left\_join()'\ option.}}}}\label{tab:unnamed-chunk-92}\\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Illustration\ of\ the\ 'right\_join()'\ option.}}}}\label{tab:unnamed-chunk-93}\\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Illustration\ of\ the\ 'anti\_join()'\ option.}}}}\label{tab:unnamed-chunk-94}\\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Basic\ Flextable}}}}\label{tab:unnamed-chunk-102}\\

\ascline{2pt}{666666}{1-6}

\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{Shiny}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{Sweet}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{Sour}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{Bitter}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{Salty}}}} \\

\ascline{2pt}{666666}{1-6}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P01}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{41.933}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{22.20}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.0000}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{8.000}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{5.100}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P02}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{39.133}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{15.80}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.0000}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{4.933}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{2.933}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P03}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{30.533}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{10.40}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.0000}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{7.800}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{4.667}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P04}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{42.600}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{16.60}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.0000}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{4.267}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{3.600}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P05}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{13.933}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{21.00}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{3.0000}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{6.733}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{5.867}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P06}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{6.867}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{14.73}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{4.0000}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{6.533}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{8.200}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P07}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{32.467}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{19.47}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.8667}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{5.000}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{2.800}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P08}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{8.933}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{14.27}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.9333}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{11.067}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{2.467}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P09}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{3.533}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{13.33}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.0000}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{9.267}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{4.000}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P10}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{26.133}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{30.47}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{5.0667}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{9.667}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{9.000}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{POpt}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{16.867}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.56in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{17.73}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{2.2000}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.59in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{15.867}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{6.667}}}} \\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Flextable\ -\ aesthetics\ improvements}}}}\label{tab:unnamed-chunk-103}\\

\ascline{2pt}{666666}{1-6}

\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Product}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Shiny}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Sweet}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Sour}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Bitter}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Salty}}}}} \\

\ascline{2pt}{666666}{1-6}\endhead



\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P01}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{41.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{22.20}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{8.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{5.10}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P02}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{39.13}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{15.80}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.93}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P03}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{30.53}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{10.40}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{7.80}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.67}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P04}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{42.60}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{16.60}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.27}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{3.60}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P05}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{13.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{21.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{3.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.73}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{5.87}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P06}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{14.73}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.53}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{8.20}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P07}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{32.47}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{19.47}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{5.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.80}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P08}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{8.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{14.27}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{11.07}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.47}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P09}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{3.53}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{13.33}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{9.27}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.00}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P10}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{26.13}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{30.47}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{5.07}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{9.67}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{9.00}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{POpt}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{16.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{17.73}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.20}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{15.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.67}}}}} \\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Flextable\ -\ coloring\ function}}}}\label{tab:unnamed-chunk-104}\\

\ascline{2pt}{FF8C00}{1-6}

\multicolumn{6}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\cellcolor[HTML]{000000}\centering}p{\dimexpr 3.31in+10\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{FFFFFF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Sensory\ Profile\ of\ 11\ biscuits}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\cellcolor[HTML]{000000}\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{FFFFFF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Product}}}}} & \multicolumn{1}{>{\cellcolor[HTML]{000000}\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{FFFFFF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Shiny}}}}} & \multicolumn{1}{>{\cellcolor[HTML]{000000}\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{FFFFFF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Sweet}}}}} & \multicolumn{1}{>{\cellcolor[HTML]{000000}\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{FFFFFF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Sour}}}}} & \multicolumn{1}{>{\cellcolor[HTML]{000000}\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{FFFFFF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Bitter}}}}} & \multicolumn{1}{>{\cellcolor[HTML]{000000}\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{FFFFFF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textbf{Salty}}}}} \\

\ascline{2pt}{FF8C00}{1-6}\endhead



\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P01}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{41.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{22.20}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{8.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{5.10}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P02}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{39.13}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{15.80}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.93}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P03}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{30.53}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{10.40}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{7.80}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.67}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P04}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{42.60}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{16.60}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.27}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{3.60}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P05}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{13.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{21.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{3.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.73}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{5.87}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P06}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{14.73}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.53}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{8.20}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P07}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{32.47}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{19.47}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{5.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.80}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P08}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{8.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{14.27}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{11.07}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.47}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P09}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{3.53}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{13.33}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{9.27}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.00}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P10}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{26.13}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{30.47}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{5.07}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{9.67}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{B3B3B3}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{9.00}}}}} \\





\multicolumn{1}{!{\color[HTML]{FF8C00}\vrule width 2pt}>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{FFA500}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{POpt}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{FFA500}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{16.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{FFA500}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{17.73}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{FFA500}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.20}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{FFA500}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{15.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}!{\color[HTML]{FF8C00}\vrule width 2pt}}{\textcolor[HTML]{FFA500}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.67}}}}} \\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Flextable\ -\ lines\ customization}}}}\label{tab:unnamed-chunk-106}\\
...
\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Flextable\ -\ conditional\ formatting}}}}\label{tab:unnamed-chunk-108}\\
...
\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P02}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{39.13}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{0000FF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{15.80}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.93}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P03}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{30.53}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{0000FF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{10.40}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{7.80}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.67}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P04}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{42.60}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{0000FF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{16.60}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.27}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{3.60}}}}} \\
...
\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P06}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{0000FF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{14.73}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.53}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{8.20}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P07}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{32.47}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{0000FF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{19.47}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{5.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.80}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P08}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{8.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{0000FF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{14.27}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.93}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{11.07}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.47}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P09}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{3.53}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{0000FF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{13.33}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{0.00}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{9.27}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{4.00}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{P10}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{26.13}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{FF0000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{30.47}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{5.07}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{9.67}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{9.00}}}}} \\





\multicolumn{1}{>{\centering}p{\dimexpr 0.65in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{POpt}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{16.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{0000FF}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{17.73}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.5in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{2.20}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{15.87}}}}} & \multicolumn{1}{>{\centering}p{\dimexpr 0.51in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{\textit{6.67}}}}} \\
...
\hypertarget{exportplots}{%
\subsubsection*{Exporting Plots}\label{exportplots}}
...
\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Protein}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Fiber}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Type}}}} \\

\ascline{2pt}{666666}{1-4}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P01}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Low}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Low}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Trial}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P02}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Low}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Trial}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P03}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Trial}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P04}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Trial}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P05}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Low}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Trial}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P06}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Low}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Trial}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P07}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Low}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Trial}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P08}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Low}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Trial}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P09}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Trial}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{P10}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Low}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Low}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Commercial\ product}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{POpt}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.66in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{High}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 0.54in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Low}}}} & \multicolumn{1}{>{\raggedright}p{\dimexpr 1.32in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Optimized\ trial}}}} \\
...
\hypertarget{sensory-descriptive-analysis}{%
\section{Sensory descriptive analysis}\label{sensory-descriptive-analysis}}
...
Judges had received thorough training for the wider biscuit product category over more than 6 months on common vocabulary following conventional descriptive analysis standards \citep{iso1995sensory, iso2012sensory}. Evaluation was performed in sensory booths in triplicates, although only individual means are available in this data set.

For each product, the judges reported the perceived intensity of each attribute using unstructured linear scales on a computer screen. Intensities were automatically converted by the acquisition system into a score ranging from 0 to 60. These data are stored in \emph{biscuits\_sensory\_profile.xlsx}.

\begin{quote}
In summary, the sensory data has 99 observations (\(11 Products\times{9 Judges}\)) and 34 variables (\emph{Judge} and \emph{Product} identifiers + 32 attributes).
\end{quote}
...
\begin{quote}
In summary, the data stored in \emph{biscuits\_traits.xlsx} have 107 observations and 62 variables giving multiple information about the consumers, including their sociodemographics, BMI and TFEQ answers. Variable codes, names, and meaning are listed in the second sheet ``Variables'', with their corresponding levels in the third sheet ``Levels''.
\end{quote}
...
\begin{quote}
In summary, the consumer test data has 1070 observations (\(10 Products\times{107 Consumers}\)) and 32 variables (including \emph{Consumer} and \emph{Product} identifiers). The \emph{biscuits\_consumer\_test.xlsx} file also include one sheet with consumption time and number of biscuits that consumers ate, and a sheet indicated the average weight for each product.
\end{quote}
...
\NormalTok{tab }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(}\AttributeTok{prod=}\FunctionTok{as.vector}\NormalTok{(}\FunctionTok{t}\NormalTok{(wdes\_5P10J)),}
...
\NormalTok{optdes\_5P13J }\OtherTok{\textless{}{-}} \FunctionTok{optFederov}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{prod}\SpecialCharTok{+}\NormalTok{judge}\SpecialCharTok{+}\NormalTok{rank, }\AttributeTok{data=}\NormalTok{tab, }\AttributeTok{augment=}\ConstantTok{TRUE}\NormalTok{,}
                           \AttributeTok{nTrials=}\NormalTok{nbJ}\SpecialCharTok{*}\NormalTok{nbP, }\AttributeTok{rows=}\DecValTok{1}\SpecialCharTok{:}\NormalTok{(nbJ}\SpecialCharTok{*}\NormalTok{nbP),}
                           \AttributeTok{nRepeats =} \DecValTok{100}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{incompDesign1 }\OtherTok{\textless{}{-}} \FunctionTok{optimaldesign}\NormalTok{(}\AttributeTok{nbPanelist=}\DecValTok{10}\NormalTok{,}
                               \AttributeTok{nbProd=}\DecValTok{5}\NormalTok{,}
                               \AttributeTok{nbProdByPanelist=}\DecValTok{3}\NormalTok{)}
...
\subsection{Incomplete designs and Sensory informed designs for hedonic tests}\label{hedo_informdes}}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(SensoMineR)}
\FunctionTok{data}\NormalTok{(cocktail)}

\NormalTok{cocktail\_pca }\OtherTok{\textless{}{-}}\NormalTok{ senso.cocktail }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{PCA}\NormalTok{(}\AttributeTok{graph =} \ConstantTok{FALSE}\NormalTok{)}

\NormalTok{Prod\_coord }\OtherTok{\textless{}{-}}\NormalTok{ cocktail\_pca}\SpecialCharTok{$}\NormalTok{ind}\SpecialCharTok{$}\NormalTok{coord[,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(AlgDesign)}
\NormalTok{Dopt\_des }\OtherTok{\textless{}{-}} \FunctionTok{optFederov}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\FunctionTok{quad}\NormalTok{(.), Prod\_coord, }\AttributeTok{nTrials=}\DecValTok{8}\NormalTok{,}
                       \AttributeTok{criterion=}\StringTok{"D"}\NormalTok{,}
                       \AttributeTok{augment =} \ConstantTok{TRUE}\NormalTok{,}
                       \AttributeTok{rows =} \FunctionTok{c}\NormalTok{(}\DecValTok{7}\NormalTok{,}\DecValTok{13}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

The resulting selection is listed in \texttt{Dopt\_des\$rows} and can be highlighted on the PCA score plot using \texttt{\{factoextra\}} and the \texttt{col.ind\ =} argument.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(factoextra)}

\NormalTok{Prod\_coord }\OtherTok{\textless{}{-}}\NormalTok{ Prod\_coord }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{as\_tibble}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{rownames\_to\_column}\NormalTok{(}\StringTok{"Product"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{DOpt\_subset =} \FunctionTok{ifelse}\NormalTok{(Product }\SpecialCharTok{\%in\%}\NormalTok{ Dopt\_des}\SpecialCharTok{$}\NormalTok{rows,}
                                \StringTok{"selected"}\NormalTok{, }\StringTok{"others"}\NormalTok{))}

\FunctionTok{fviz\_pca\_ind}\NormalTok{(cocktail\_pca,}
             ...
             \AttributeTok{labelsize =} \DecValTok{4}\NormalTok{, }\AttributeTok{repel =} \ConstantTok{TRUE}\NormalTok{,}
             \AttributeTok{col.ind =}\NormalTok{ Prod\_coord}\SpecialCharTok{$}\NormalTok{DOpt\_subset,}
             \AttributeTok{palette =} \FunctionTok{c}\NormalTok{(}\StringTok{"\#949494"}\NormalTok{, }\StringTok{"\#00AFBB"}\NormalTok{),}
             \AttributeTok{legend.title =} \StringTok{"Subset"}\NormalTok{,}
             \AttributeTok{show.legend.text =} \ConstantTok{FALSE}\NormalTok{,}
             \AttributeTok{mean.point =} \ConstantTok{FALSE}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:unnamed-chunk-202}Highlighted D-optimal selection of products on the sensory map}
\end{figure}
...
\NormalTok{Subset\_coord }\OtherTok{\textless{}{-}}\NormalTok{ Dopt\_des}\SpecialCharTok{$}\NormalTok{design }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{as\_tibble}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
                \FunctionTok{mutate}\NormalTok{(}\StringTok{"Product"} \OtherTok{=} \FunctionTok{factor}\NormalTok{(Dopt\_des}\SpecialCharTok{$}\NormalTok{rows), }\AttributeTok{.before=}\DecValTok{1}\NormalTok{)}

\NormalTok{Subset\_table }\OtherTok{\textless{}{-}} \FunctionTok{flextable}\NormalTok{(Subset\_coord) }\SpecialCharTok{\%\textgreater{}\%}
...
\begin{longtable}[c]{|p{0.64in}|p{0.55in}|p{0.55in}}

\caption{\textcolor[HTML]{000000}{\fontsize{11}{13}\selectfont{\global\setmainfont{Arial}{Basic\ Flextable}}}}\label{tab:unnamed-chunk-204}\\

\ascline{2pt}{666666}{1-3}

\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{Dim.1}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{Dim.2}}}} \\

\ascline{2pt}{666666}{1-3}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{1}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.99}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{3.51}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{4}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{-4.63}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{1.68}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{7}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{1.49}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{1.89}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{8}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.08}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.48}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{12}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{-4.21}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{-2.72}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{13}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{3.99}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{-0.70}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{15}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{4.31}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{0.55}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.64in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{16}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{1.38}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.55in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{8}{8}\selectfont{\global\setmainfont{Calibri}{-3.30}}}} \\
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Xopti }\OtherTok{=} \FunctionTok{model.matrix}\NormalTok{(}\SpecialCharTok{\textasciitilde{}} \FunctionTok{quad}\NormalTok{(.), Dopt\_des}\SpecialCharTok{$}\NormalTok{design)}
\FunctionTok{det}\NormalTok{(}\FunctionTok{t}\NormalTok{(Xopti)}\SpecialCharTok{\%*\%}\NormalTok{Xopti)}
\end{Highlighting}
\end{Shaded}
...
In itself, this value is not really telling. However, it can be compared to the determinant of the information matrix (X'X) for another subset (e.g., without the forced selection of two products, or a subset of different size) and see by how much it has improved or deteriorated. The determinant could also be used in an optimization loop to define complementary subsets to be allocated to different consumers or groups of consumers.
...
\caption{\label{fig:unnamed-chunk-206}Ternary diagram of a simplex-lattice mixture design with 3 components}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-208}D-optimal mixture design with constrained factors}
\end{figure}
...
\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Product}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.61in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Butter}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Sugar}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Flour}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{Liking}}}} \\

\ascline{2pt}{666666}{1-5}\endhead



\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{A}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.61in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.300}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.250}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.450}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{7.5}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{B}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.61in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.150}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.400}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.450}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{5.4}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{C}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.61in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.300}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.400}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.300}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{5.5}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{D}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.61in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.250}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.250}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.500}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{7.0}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{E}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.61in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.150}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.350}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.500}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{6.0}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{F}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.61in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.300}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.325}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.375}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{8.0}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{G}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.61in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.225}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.400}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.375}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{5.8}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{H}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.61in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.200}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.300}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.500}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{6.8}}}} \\





\multicolumn{1}{>{\raggedright}p{\dimexpr 0.69in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{I}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.61in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.230}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.330}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.57in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{0.440}}}} & \multicolumn{1}{>{\raggedleft}p{\dimexpr 0.58in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{\global\setmainfont{Calibri}{7.9}}}} \\
...
\caption{\label{fig:unnamed-chunk-210}Modeled liking displayed as a contour plot on the ternary diagram}
\end{figure}
...
\hypertarget{sensory-informed-designs-for-product-development}{%
\subsection{Sensory informed designs for product development}\label{sensory-informed-designs-for-product-development}}
...
\caption{\label{fig:unnamed-chunk-227}Visualization of missing values in the sensory dataset using visdat::vismiss()}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-229}Visualization of the pattern of missing values in the sensory data thanks to naniar::gg\_miss\_upset()}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-230}Visualization of missing values for Sour with geom\_miss\_point()}
\end{figure}
...
\begin{verbatim}
## Warning: There was 1 warning in `mutate()`.
## i In argument: `TextN = as.numeric(Text)`.
## Caused by warning:
...
\caption{\label{fig:unnamed-chunk-262}Sensory attributes ranked by decreasing F-values of the product effect in their respective ANOVA}
\end{figure}
...
\begin{figure}
\includegraphics[width=15.86in]{images/PCA_patchwork} \caption{Display of PCA plots using \textit{factoextra}}\label{fig:unnamed-chunk-268}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-271-1.pdf}
\caption{\label{fig:unnamed-chunk-271-1}Bar plots showing the respondent distributions for the various demographic variables}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-271-2.pdf}
\caption{\label{fig:unnamed-chunk-271-2}Bar plots showing the respondent distributions for the various demographic variables}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-271-3.pdf}
\caption{\label{fig:unnamed-chunk-271-3}Bar plots showing the respondent distributions for the various demographic variables}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-271-4.pdf}
\caption{\label{fig:unnamed-chunk-271-4}Bar plots showing the respondent distributions for the various demographic variables}
\end{figure}
...
\begin{figure}
\includegraphics[width=14.76in]{images/TFEQ_barplots_facet} \caption{Frequency distributions for Disinhibition-related variables only}\label{fig:unnamed-chunk-277}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-282}Vizualisation of the distributions of the TFEQ factors for the consumer panel}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-286}Bar chart for the the comparison of mean liking scores at the first bite and at the end of the evaluation}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-287}Faceted scatterplots showing the linear relationship between overal liking at the first bite vs.~end of the tasting for the first 12 consumers}
\end{figure}
...
\begin{figure}
\includegraphics[width=12.43in]{images/Scatter_eating_vs_liking} \caption{Consumers showing a significant relationship between their liking scores and the number of biscuits they ate}\label{fig:unnamed-chunk-292}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-293-1}Internal Preference Mapping (PCA of consumer data with sensory descriptors as supplementary variables)}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-293-2.pdf}
\caption{\label{fig:unnamed-chunk-293-2}Internal Preference Mapping (PCA of consumer data with sensory descriptors as supplementary variables)}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-295}Agglomerative Hierarchical Clustering of consumers' centered liking scores}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-297-1.pdf}
\caption{\label{fig:unnamed-chunk-297}Average liking scores of the two consumer clusters}
\end{figure}
...
\begin{figure}
\includegraphics[width=16.36in]{images/Correl_matrix} \caption{Matrix of pairwise correlations between attributes}\label{fig:unnamed-chunk-300}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-306-1.pdf}
\caption{\label{fig:unnamed-chunk-306}Regression of liking on sensory atttributes taken separately}
\end{figure}
...
\NormalTok{nconso }\OtherTok{=} \FunctionTok{ncol}\NormalTok{(consu)}
...
The sensory space is stored in \texttt{senso}, whereas the response surface plot information is split between:
...
\NormalTok{PrefMap\_plot }\OtherTok{\textless{}{-}}\NormalTok{ PrefMap}\SpecialCharTok{$}\NormalTok{nb.depasse }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{pivot\_longer}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{Dim1, }
               \AttributeTok{names\_to =} \StringTok{"Dim2"}\NormalTok{, }\AttributeTok{values\_to =} \StringTok{"Count"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\StringTok{"Preference (\%)"} \OtherTok{=}\NormalTok{ Count }\SpecialCharTok{*} \DecValTok{100} \SpecialCharTok{/}\NormalTok{ nconso) }\SpecialCharTok{\%\textgreater{}\%} 
...
\caption{\label{fig:unnamed-chunk-309}Plot of the External Preference Mapping using ggplot2}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-312}PCA Biplot}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-314-1.pdf}
\caption{\label{fig:unnamed-chunk-314}Optimal Number of Clusters}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-315}Cluster Plot}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-316}Tuning Plot}
\end{figure}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-346-1.pdf}
...
\item
  \emph{Rapid Sensory Profiling Techniques (2nd Edition)} by Julien Delarue and J. Ben Lawlor
\item
...
\tightlist
\item
  \texttt{ClustBlock}: hierarchical and partitioning algorithms of blocks of variables. Includes functions for clustering subjects and multivariate analysis of multiblock sensory data, such as Check-All-that-Apply (CLUSCATA), or Free Sorting (CLUSTATIS).
\item
  \texttt{ClustVarLV}: functions for the clustering of variables around Latent Variables, for 2-way or 3-way data.
\item
  \texttt{corrplot}: provides a visual exploratory tool on correlation matrix that supports automatic variable reordering to help detect hidden patterns among variables.
\item
  \texttt{DistatisR}: implements three-way multidimensional scaling. DiSTATIS is used to analyze multiple distance matrices collected on the same set of observation (e.g., by free sorting).
\item
...
\item
  \texttt{FactoMineR}: dedicated to multivariate Exploratory Data Analysis including Principal Components Analysis (PCA), Correspondence analysis (CA), Multiple Correspondence Analysis (MCA), clustering.
\item
  \texttt{rstatix}: a pipe-friendly framework, coherent with the `tidyverse' design philosophy, for performing basic statistical tests.
\item
  \texttt{sensmixed}: to analyze sensory and consumer data within mixed effects model framework.
\item
  \texttt{SensoMineR}: dedicated to the statistical analysis of sensory data. It tackles the characterization of the products, panel performance assessment, links between sensory and instrumental data, consumer's preferences, napping evaluation, optimal designs.
\item
  \texttt{SensR}: for Thurstonian Models for sensory discrimination methods, including duotrio, tetrad, triangle, 2-AFC, 3-AFC, A-not A, same-different, 2-AC and degree-of-difference. This package enables the calculation of d-primes, standard errors of d-primes, sample size and power computations, and comparisons of different d-primes.
\item
  \texttt{stats}: contains functions for statistical calculations and random number generation. The analysis include ANOVA, posthoc tests, Clustering, Correlation, multivariate analysis, among many others.
\item
  \texttt{tempR}: for Analysis and visualization of data from temporal sensory methods, including temporal check-all-that-apply (TCATA) and temporal dominance of sensation.
\end{itemize}
