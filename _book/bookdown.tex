...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(AlgDesign)}
\NormalTok{Dopt\_des }\OtherTok{\textless{}{-}} \FunctionTok{optFederov}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\FunctionTok{quad}\NormalTok{(.), Prod\_coord, }\AttributeTok{nTrials=}\DecValTok{8}\NormalTok{, }\AttributeTok{criterion=}\StringTok{"D"}\NormalTok{, }\AttributeTok{augment =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{rows =} \FunctionTok{c}\NormalTok{(}\DecValTok{7}\NormalTok{,}\DecValTok{13}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

The resulting selection is listed in \texttt{Dopt\_des\$rows} and can be highlighted on the PCA score plot using \texttt{\{factoextra\}} using the \texttt{col.ind\ =} argument.
...
\NormalTok{Prod\_coord }\OtherTok{\textless{}{-}}\NormalTok{ Prod\_coord }\SpecialCharTok{\%\textgreater{}\%}
    ...
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{DOpt\_subset =} \FunctionTok{ifelse}\NormalTok{(Product }\SpecialCharTok{\%in\%}\NormalTok{ Dopt\_des}\SpecialCharTok{$}\NormalTok{rows,}\StringTok{"selected"}\NormalTok{, }\StringTok{"others"}\NormalTok{))}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-267-1.pdf}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-275-1.pdf}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-290-1.pdf}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-290-2.pdf}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-302-1.pdf}
...
\NormalTok{PrefMap\_plot }\OtherTok{\textless{}{-}}\NormalTok{ PrefMap}\SpecialCharTok{$}\NormalTok{nb.depasse }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{mutate}\NormalTok{(}\StringTok{"Acceptance (\%)"} \OtherTok{=}\NormalTok{ Count }\SpecialCharTok{*} \DecValTok{100} \SpecialCharTok{/}\NormalTok{ nconso) }\SpecialCharTok{\%\textgreater{}\%} 
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-337-1.pdf}
