...
```{r gttable, fig.cap='gt Table.', fig.align='center', echo=FALSE, out.width="50%", eval=TRUE}
...
```{r gttabledesigned, fig.cap='gt Table - coloring function.', fig.align='center', echo=FALSE, out.width="30%", eval=TRUE}
...
```{r gttextratable, fig.cap='gtExtra Table.', fig.align='center', echo=FALSE, out.width="40%", eval=TRUE}
