...
```{r, eval=TRUE, echo=FALSE, tab.cap="Appearance Attributes Mean_Basic Flextable"}
flex_table %>% 
...
```{r, eval=TRUE, echo=FALSE, tab.cap="Appearance Attributes Mean_Basic Flextable 2)"}
flex_table_design %>% 
  font(fontname = "Calibri", part="all") %>% 
  fontsize(size=8, part="all") %>% 
  autofit()
...
```{r, eval=TRUE, echo=FALSE,tab.cap="Appearance Attributes Mean_Improved Flextable"}
flex_table_design %>%
  bg(bg = "black", part = "header") %>% 
  color(color = "white", part = "header") %>% 
  fontsize(size = 13, part = "header", i = 1) %>%
...
```{r, echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE, tab.cap="Appearance Attributes Mean_Improved Flextable"}
library(officer)
flex_table_design %>%
  hline(i=10, border=fp_border(color="grey70", style="dashed")) %>%
  font(fontname = "Calibri", part="all") %>% 
...
```{r, echo=FALSE, eval=TRUE, tab.cap="Appearance Attributes Mean_Improved Flextable 3"}
color_code <- ifelse(mean_sensory$Sweet <= 20, "blue", 
                     ifelse(mean_sensory$Sweet >= 30, "red", "black"))
flex_table_design %>% 
  color(j=~Sweet, color=color_code)%>%
