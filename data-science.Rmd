...
Don't edit raw data. Haven't we all worked with multiple versions of the same file, not knowing anymore what are the differences?
Document (and justify) the changes.
When coding, do not repeat more than 3 times the same block of code. If you need to do so, then look for better alternatives such as loops, automation, or create functions to be called...
