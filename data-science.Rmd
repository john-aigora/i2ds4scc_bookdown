...
Data transformation is slightly different from data preparation.  In data preparation, we prepare the raw data for processing.

Imputing missing data?

Create secondary variables or new features
Decorrelate data
