...
Types of Supervised Learning <!-- add a sentence of two (Vanessa) --> 
...
<!-- Maybe add some little section before each part of the code -->
...
We can use `autoplot()` function to take a quick look at the `tuning` object.<!-- explain the graph here? --> 
...
<!-- Do we want to include another regression example? it's more common in the sensory consumer science context -->
<!-- Do we want to add modelStudio? -->