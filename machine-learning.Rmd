...
var_imp <- variable_importance(explainer, loss_function = loss_cross_entropy)
plot(var_imp)
...
precision(obs_vs_pred, truth = "Type", estimate = ".pred_class")
specificity(obs_vs_pred, truth = "Type", estimate = ".pred_class")
