...
In the sensory and consumer science field, unsupervised learning models are usually used for Clustering and Dimensionality Reduction. As the latest technique is commonly used for data preprocessing, to reduce to number of features in a dataset, it will be embedded in the Clustering example.
