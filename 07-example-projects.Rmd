...
> In summary, the sensory data has 99 observations ($11 Products\times{9 Judges}$) and 34 variables (*Judge* and *Product* identifiers + 32 attributes).
...
> In summary, the consumer test data has 1070 observations ($10 Products\times{107 Consumers}$) and 32 variables (including *Consumer* and *Product* identifiers). The *biscuits_consumer_test.xlsx* file also include one sheet with consumption time and number of biscuits that consumers ate, and a sheet indicated the average weight for each product.
