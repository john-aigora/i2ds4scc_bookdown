...
```{r trade-off, fig.cap='Trade-off curve based on the level of technical details and the big picture for each type of audience.', fig.align='center', echo=TRUE, eval=FALSE}
