...
>  At this point you are likely well familiar with data collection, data preparation, and data analysis. You probably have very nice charts and plots and are excited to share them with your team or client, so it's time to discuss one of the very last steps, how to deliver it. Effective communication is as much important as any other step and so, we will guide you through that, providing some valuable tips and practical examples. This chapter approaches important topics to help you reach the goal of successful communication, from understanding the distinction between different analysis and audience awareness to methods to communicate, the art of storytelling, and ultimately reformulate.
...
One of the most important things about being a successful consultant is Audience Awareness! No matter how good you, your team, and the service or product your company offers if you fail to communicate with your target audience. Knowing the audience, who the target people you will be is just the cornerstone of any successful business. Knowing your audience makes you be better able to connect to them. 
...
We won’t go deep into the interpretation since it’s not the focus of this example, but rather point out the approach we would recommend for each type of audience as shown in the Table \@ref(tab:summary-table)).


```{r summary-table,message=FALSE, warning=FALSE, tab.cap="Exemplification of the approach for each type of audience."}
