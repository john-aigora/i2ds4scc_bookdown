...
<!-- Vanessa: I added a section before "Know your audience" to discuss the Exploratory vs. Explanatory Analysis (included  Julien's thoughts/example).The only thing missing is to show some plots to exemplify --> 
...
```{r pca, fig.cap='PCA Biplot Biscuit Study.', fig.align='center', echo=FALSE, out.width="85%", eval=TRUE}
...
<!-- If the idea of the table is good, it has to be rebuild in Rmd--> 

```{r table, fig.cap='Exemplification of the approach for each type of audience.', fig.align='center', echo=FALSE, eval=TRUE}

knitr::include_graphics("images/table_value_delivery.jpg")
...
```{r pcamanagement, fig.cap='PCA Biplot Biscuit Study Modified.', fig.align='center', echo=FALSE, out.width="85%", eval=TRUE}
